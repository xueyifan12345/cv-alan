...
export default function JacoboAgent({ lang = 'en' }: { lang?: Lang }) {
  ...
  useArticleSeo({
    ...
    image: 'https://xueyifan.io/jacobo/og-jacobo-agent.webp',
  ...
  return (
    <ArticleLayout lang={lang}>
      ...
      <GitHubRepoBadge repo="xueyifan/jacobo-workflows" stars="120" forks="38" lang={lang} />
      ...
      <Photo2 editorId="hero-photos" items={[
        { src: '/jacobo/Yifan-headphones-thinking.webp', alt: 'Yifan Fernández de Valderrama', loading: 'eager', width: 360, height: 480 },
        { src: '/jacobo/shop-microsoldering-station.webp', alt: lang === 'zh' ? '薛一凡 iRepair 的微焊台' : 'Microsoldering station at Xueyifan iRepair', loading: 'eager', width: 540, height: 720 },
      ...
      <article className="prose-custom">
        ...
        <Photo2 editorId="problem-shop-counter" items={[
          { src: '/jacobo/shop-counter-smart-displays.webp', alt: lang === 'zh' ? 'Mostrador de Xueyifan iRepair con smart displays' : 'Xueyifan iRepair counter with smart displays', width: 1024, height: 768 },
        ...
        <ScreenshotGrid editorId="email-formal-flow" lang={lang} items={[
          ...
          { src: 'email-formal-3.webp', altEs: 'Firma: "Un saludo, Jacobo — Xueyifan iRepair — dirección + teléfono + email"', altEn: 'Signature: "Best regards, Jacobo — Xueyifan iRepair — address + phone + email"', width: 1170, height: 2532 },
        ]} />
        ...
        <InlineWorkflowDownload href={wfById['calculadora-xueyifan'].href} label={t.downloads.inlineLabel} fileSize={wfById['calculadora-xueyifan'].fileSize} />
        ...
        <CaseStudyCta
          ...
          ctaHref="https://linkedin.com/in/xueyifan"
          external
          secondaryLabel={`${(t.cta as any).labelSecondary} →`}
          secondaryHref="mailto:yifanxue.sde@gmail.com"
        />
        ...
        <div className="flex justify-center mb-4">
          <a
            href="https://github.com/xueyifan/jacobo-workflows"
            target="_blank"
