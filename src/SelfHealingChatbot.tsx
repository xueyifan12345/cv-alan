...
export default function SelfHealingChatbot({ lang = 'en' }: { lang?: Lang }) {
  ...
  useArticleSeo({
    ...
    image: 'https://xueyifan.io/chatbot/og-self-healing-chatbot.webp',
  ...
  return (
    <ArticleLayout lang={lang}>
      ...
      <a href="#architecture" className="inline-flex items-center gap-2 -mt-4 mb-6 text-sm font-medium text-primary hover:text-primary/80 transition-colors">
        {lang === 'zh' ? '查看交互式架构演示 →' : 'See interactive architecture demo →'}
      </a>
      ...
      <article className="prose-custom">
        ...
        <ArchitectureDiagram
          ...
          label={lang === 'zh' ? '交互式架构' : 'Interactive Architecture'}
          subtitle={lang === 'zh' ? '10 个阶段 · 语音解说 · 缩放 + 平移' : '10 phases · narrated audio · zoom + pan'}
        />
